...
## React & Next.js Performance | ref: .agent/skills/vercel-react-best-practices/SKILL.md
...
## React Composition | ref: .agent/skills/vercel-composition-patterns/SKILL.md
...
## React Native / Expo | ref: .agent/skills/vercel-react-native-skills/SKILL.md
...
## PostgreSQL / Supabase | ref: .agent/skills/postgres-expert/SKILL.md
...
## Server Actions | ref: .agent/skills/server-action-builder/SKILL.md
...
## Service Layer | ref: .agent/skills/service-builder/SKILL.md
...
## React Forms | ref: .agent/skills/react-form-builder/SKILL.md
...
## Playwright E2E | ref: .agent/skills/playwright-e2e/SKILL.md
