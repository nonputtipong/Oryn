...
**5. Maintainability** -- Choose the simplest approach. Follow service, server action, and loader patterns from `patterns.md` and `coding-style.md`. Future developers (and AI Agents) need to understand this without extra context.
